package cn.fire.elasticJob.util;
...
//        }
     ...
     * 多线程实现查询和添加一个原子操作
     */
//    void queryAndUpdateByMultiThread() {
...
//
//                        menu2Mapper.insert2(menus.get(j));
//                    }
//
//                }).start();
//            }
...
//    }
    ...
    public static void main(String[] args) {
       ...
       // new ThreadTest().queryAndUpdateByMultiThread();
    }
}
